...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0 z-50">
      <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-[#ffa500]">
        Student Information <br /> & Accounting System (SIAS)
      </h1>
      <p className="text-xl mt-8 text-primary dark:text-white font-semibold">
        Online Real-time Learning & Accounting Management System.
      </p>
      <br />
